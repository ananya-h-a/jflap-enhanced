...
public class CustomEditorPane extends EditorPane {
	 ...
	 */
	public CustomEditorPane(Automaton automaton) {
	 ...
	 */
	public CustomEditorPane(Automaton automaton, ToolBox box) {
	 ...
	 */
	public CustomEditorPane(AutomatonDrawer drawer) {
	 ...
	 */
	public CustomEditorPane(AutomatonDrawer drawer, ToolBox box) {
	 ...
	 */
	public CustomEditorPane(AutomatonDrawer drawer, ToolBox box, boolean fit) {
		super(drawer, box, false);
		pane = new EditCanvas(drawer, fit);
		pane.setCreator((EditorPane)this);
		this.drawer = drawer;
		...
		box = new ToolBox() {
			public List tools(AutomatonPane view, AutomatonDrawer drawer) {
				...
				tools.add(new CustomArrowTool(view, drawer));
