...
public class CustomFSAToREController extends FSAToREController {
	/**
	 ...
	 */
	public CustomFSAToREController(FiniteStateAutomaton automaton,
			SelectionDrawer drawer, JLabel mainStep, JLabel detailStep,
			JFrame frame) {
		super( automaton, drawer,  mainStep,  detailStep,
			 frame);
	...
	protected void outOfOrder() {
		if(!ConvertFSAToREActionNew.customConvertAction)
	...
	protected void nextStep() {
		// This is to stop the constructor flow of the parent class, because this is the case where
	//	nextstep is called from the parent class' constructor and we dont need that flow.
		...
		case FINISHED:
			...
			ConvertFSAToREActionNew.computedRE = computedRE;
