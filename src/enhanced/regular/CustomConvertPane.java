...
public class CustomConvertPane extends JPanel {
	/**
	 ...
	 */
	public CustomConvertPane(AutomatonEnvironment environment) {
		...
		final CustomFSAToREController controller = new CustomFSAToREController(automaton,
