...
public class TextAndInput extends AutomatonAction {
	private Grammar gram;

	/**
	 * Instantiates a new <CODE>TextAndInput</CODE>.
	 * 
	 * @param automaton
	 ...
	 */
	public TextAndInput(Automaton automaton, Environment environment) {
		super("Step...", null);
	...
	public TextAndInput(Grammar gram, Environment environment) {
		super("Step...", null);
		if (SimulateNoClosureAction.isApplicable(automaton))
			putValue(NAME, "Step with Closure...");
		putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_R,
	...
	public void handleInteraction(Automaton automaton,
			...
			Object initialInput) {
		System.out.println("In function handleInteraction");
	...
	protected Object initialInput(Component component, String title) {
		System.out.println("In function initialInput");
	...
	private Object openInputGUI(final Component component, String title, final int tapes) {
		System.out.println("In function openInputGUI");
		...
		JButton jb=new JButton("Click to Open Input File(nitish)");
		jb.addActionListener(new ActionListener(){

			public void actionPerformed(ActionEvent e) {
				System.out.println("In function actionPerformed 1");
				// TODO Auto-generated method stub
	...
	{
		System.out.println("in function handleInputFile");
	 ...
	 */
	public void actionPerformed(ActionEvent e) {
		System.out.println("In function actionPerformed 2");
	...
	protected boolean automatonActionPermissible(Component source) {
		System.out.println("In function automatonActionPermissible");
