...
public class FrontEnd 
{
   ...
   private LinkedList<studentCode> myList;
   private studentCode myCode;
   ...
   public FrontEnd()
   {
      ...
      myList = new LinkedList<studentCode>();
      myCode = new studentCode();
      fixedDisplay = new String("x is such that ");
      enable(boolean_type);
   }
   ...
   public void actionPerformed(final String[] alphabet)
   {
     ...
     AndButton.addActionListener(
      ...
      TranslateButton.addActionListener(
            new ActionListener() {
               public void actionPerformed(ActionEvent evt) {  
                  JOptionPane.showMessageDialog(fr1, fixedDisplay);	
               }                            
            });
      ...
      FollowedBy.addActionListener(
              new ActionListener() {
               public void actionPerformed(ActionEvent evt) {
                 fixedDisplay += " followed by x such that ";
                 myCode = new studentCode();
                 enable(boolean_type);
               }
            });
   ...
   {
      String extra = exp(myCode.getRoot());
      if(classType == null) {
         enable(null);
         myList.add(myCode);
         fixedDisplay += extra;
         ...
         enable(string_type);
      TextArea.setText(fixedDisplay + extra);
   }
   private void addToTree(TreeNode tnode)
   {
      Class nextType = myCode.buildTree(tnode);
      nullCount = 0;
   ...
   public LinkedList<studentCode> getList()
   {
      return myList;
   }
