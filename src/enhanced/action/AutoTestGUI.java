 ...
 */
   ...
   import enhanced.CustomJTableExtender;
...
import automata.fsa.FSAAlphabetRetriever;
    ...
    */
       protected CustomJTableExtender initializeTable(Object obj) {
         ...
         CustomJTableExtender table = new CustomJTableExtender(model, this);
                     ...
                     if(getObject() instanceof Automaton){
                        ...
                        // Is this a Turing machine?
                           ...
                           int solution_result = 2;
                              try {
											  	LinkedList<studentCode> list = frontend.getList();
												if( list!= null )
												{
		solution_result = eval(list, (String)input) ?  0 : 1;																																				
											   }
                                  }
                      ...
                      public void actionPerformed(ActionEvent arg0) {		            
                        ...
                        if(k>=0 && k < getEnvironment().myObjects.size()){
                           if(getObject() instanceof Automaton){
                              ...
                              CustomEditorPane ep = new CustomEditorPane(cur);
      ...
      // Set up the final view.
       ...
       public void viewAutomaton(CustomJTableExtender table){
         InputTableModel model = (InputTableModel) table.getModel();
         if(model.isMultiple){        	 			
            int row = table.getSelectedRow();
            if(row < 0) 
    ...
    * @param machineFileName
     * 
     */
       protected void updateView(String machineFileName, String input, CustomJTableExtender table) {
