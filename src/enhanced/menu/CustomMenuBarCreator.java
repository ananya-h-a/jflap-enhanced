...
import enhanced.action.AutoTestGUI;
import enhanced.action.CompareDFAAction;
import enhanced.action.OpenFileFromRepositoryAction;
import enhanced.action.SaveAsProblemAction;
 ...
 */
    ...
    public class CustomMenuBarCreator {
   /**
         ...
         */
          ...
          if (fsa.fromSaveProblem) {
            ...
            SaveProblemButton.addActionListener(
                   new ActionListener() {
                      public void actionPerformed(ActionEvent e) {
                        SaveAsProblemAction sa = new SaveAsProblemAction(frame.getEnvironment());
            ...
            if (fsa.fromOriginalAnswer) {
               if (DFAEqualityAction.isApplicable(frame.getEnvironment()
               	.getObject()) && OpenFileFromRepositoryAction.openedAutomaton != null) {
                  button = new JButton("Test Against Solution");
                  button.addActionListener(
                         new ActionListener() {
                            public void actionPerformed(ActionEvent e) {
                           
                              CompareDFAAction dfa = new CompareDFAAction(
         ...
         /*
            ...
            if (fsa.fromOriginalAnswer || fsa.isFromNewAction() || fsa.fromSolve) {
            	 JButton autoTestDFA = new JButton("Test Against Code");
                 autoTestDFA.addActionListener(
                        new ActionListener() {
    ...
    */
       private static JMenu getFileMenu(EnvironmentFrame frame) {
         ...
         // Can't open and save files.
            ...
            SaveAsProblemAction sa = new SaveAsProblemAction(environment);
            addItem(menu, sa);
